...
const LOJAS = [
  ...
  { id: 'armazem_guilda', nome: 'Armazém da Guilda', lugar: 'Sede da Guilda de Verdom', dono: 'Mestra-intendente Oriane', mult: 1.1,
    ...
    itens: ['espada_sedenta','botas_salto','escudo_contra_ataque','anel_ferro','anel_prata','cinto_couro','talisma_apostador','espada_bastarda','arco_composto','lanca_cavaleiro','besta_mao',
...
const DUNGEONS = [
  { id: 'ninho_ratos', nome: 'O Ninho sob a Taverna', tipo: 'cidade_subterranea', dificuldade: 1, nivel: 1, lugar: 'Cidade Baixa (Verdom)', descricao: 'O dono da taverna do Porco Manco ouve arranhões no porão há semanas. Por trás de um barril, alguém cavou um túnel até os esgotos antigos.', segredoFinal: 'O túnel não foi cavado por ratos: é uma passagem velha de contrabandistas de Vermilion, que ainda liga metade das casas da Cidade Baixa.', salas: [ { id: 'porao', nome: 'Porão da taverna', tipo: 'entrada', x: 0, y: 1, texto: 'Barris, cheiro de cerveja azeda e um buraco atrás do barril maior.' }, { id: 'tunel', nome: 'Túnel estreito', tipo: 'combate', x: 1, y: 1, texto: 'Ratos do tamanho de cachorros brigam por restos.', inimigos: [ 'rato_gigante', 'rato_gigante' ] }, { id: 'despensa', nome: 'Despensa esquecida', tipo: 'tesouro', x: 1, y: 0, texto: 'Caixotes de contrabando de décadas atrás.', tesouro: { dinheiro: 150, itens: [ { id: 'cinto_couro' } ] } }, { id: 'degrau', nome: 'Degrau falso', tipo: 'armadilha', x: 2, y: 1, texto: 'Uma pedra solta no meio do túnel.', teste: 'PER para notar, DEX para pular', falha: 'Torce o tornozelo: −1 de movimento até descansar.' }, { id: 'marcas', nome: 'Parede das marcas', tipo: 'segredo', x: 2, y: 2, texto: 'Riscos na parede contam dias, e um brasão antigo: uma torre com uma chama. É o brasão de Vermilion.', segredo: 'Contrabandistas de Vermilion usavam estes túneis antes da cidade cair.' }, { id: 'ninho', nome: 'O ninho', tipo: 'chefe', x: 3, y: 1, texto: 'Um monte de trapos e ossos onde a maior ratazana dorme.', inimigos: [ 'rato_gigante', 'rato_gigante', 'goblin' ] }, { id: 'passagem', nome: 'Passagem dos contrabandistas', tipo: 'segredo', x: 3, y: 0, texto: 'Atrás do ninho, uma porta de madeira podre com uma fechadura de bronze.', oculta: true, segredo: 'A passagem continua até os Esgotos de Verdom e até o porão de pelo menos três casas nobres.', tesouro: { dinheiro: 500 } } ], conexoes: [ [ 'porao', 'tunel' ], [ 'tunel', 'despensa' ], [ 'tunel', 'degrau' ], [ 'degrau', 'marcas' ], [ 'degrau', 'ninho' ], [ 'ninho', 'passagem', 'Porta escondida atrás do ninho' ] ] },
  { id: 'grutas_troll', nome: 'As Grutas do Troll', tipo: 'caverna', dificuldade: 3, nivel: 5, lugar: 'Grutas do Troll', descricao: 'Cavernas úmidas nas montanhas a noroeste de Verdom. O troll que dá nome ao lugar existe, e tem fome.', segredoFinal: 'As pinturas mais antigas mostram figuras altas e magras moldando outras figuras de barro: os elfos criando os orcs, eras antes de qualquer reino.', salas: [ { id: 'boca', nome: 'Boca da caverna', tipo: 'entrada', x: 0, y: 2, texto: 'Ossos de ovelha espalhados na entrada. O cheiro é forte.' }, { id: 'morcegos', nome: 'Galeria dos morcegos', tipo: 'combate', x: 1, y: 2, texto: 'O teto se mexe.', inimigos: [ 'morcego_gigante', 'morcego_gigante' ] }, { id: 'poco', nome: 'O poço', tipo: 'armadilha', x: 2, y: 1, texto: 'O chão termina num poço escuro coberto de musgo escorregadio.', teste: 'DEX ou AGI', falha: 'Cai 3 metros: 2d10 × nível e fica separado do grupo por 1 turno.' }, { id: 'lago', nome: 'Lago subterrâneo', tipo: 'bencao', x: 2, y: 3, texto: 'Água gelada e cristalina que pinga do teto.', efeito: 'Quem beber recupera 25% da vida e fica imune a veneno por 1 hora.' }, { id: 'pinturas', nome: 'Parede das pinturas', tipo: 'segredo', x: 3, y: 3, texto: 'Pinturas vermelhas muito antigas cobrem a rocha.', segredo: 'As figuras altas moldando outras de barro contam a criação dos orcs pelos elfos, sob a ordem do Deus Único.' }, { id: 'ossos', nome: 'Câmara dos ossos', tipo: 'tesouro', x: 3, y: 1, texto: 'Restos de aventureiros que não voltaram.', tesouro: { dinheiro: 2000, itens: [ { id: 'elmo_cavaleiro' }, { id: 'anel_guarda', chance: 50 } ] } }, { id: 'fenda', nome: 'Fenda estreita', tipo: 'segredo', x: 4, y: 3, texto: 'Uma fresta por onde só passa quem tirar a armadura.', oculta: true, segredo: 'A fenda sai do outro lado da montanha, perto do Forte Anão da Guarda.', tesouro: { itens: [ { id: 'coifa_runica' } ] } }, { id: 'covil', nome: 'Covil do troll', tipo: 'chefe', x: 4, y: 2, texto: 'Um buraco fedido cheio de ossos roídos. O troll ri quando vê o grupo.', inimigos: [ 'troll' ] }, { id: 'tesouro_troll', nome: 'O tesouro do troll', tipo: 'tesouro', x: 5, y: 2, texto: 'Tudo que brilhava e o troll achou bonito.', tesouro: { dinheiro: 8000, itens: [ { id: 'coracao_troll', chance: 20 }, { id: 'espada_bastarda' } ] } } ], conexoes: [ [ 'boca', 'morcegos' ], [ 'morcegos', 'poco' ], [ 'morcegos', 'lago' ], [ 'lago', 'pinturas' ], [ 'poco', 'ossos' ], [ 'pinturas', 'fenda', 'Fresta atrás das pinturas' ], [ 'ossos', 'covil' ], [ 'pinturas', 'covil' ], [ 'covil', 'tesouro_troll' ] ] },
  { id: 'becos_verdom', nome: 'A Noite dos Becos', tipo: 'cidade', dificuldade: 3, nivel: 7, lugar: 'Cidade Baixa (Verdom)', descricao: 'Cultistas do Deus Marcado se reúnem em algum lugar da Cidade Baixa. O grupo tem uma noite para achar o esconderijo antes que a guarda feche os portões.', segredoFinal: 'As cartas do líder mostram que o culto em Verdom recebe ordens de alguém no Reino de Sombrath, onde um Aralto manipula o rei há mais de uma geração.', salas: [ { id: 'praca', nome: 'Praça do poço', tipo: 'entrada', x: 0, y: 2, texto: 'A última lamparina da praça. Dois caminhos: a taverna e o mercado.' }, { id: 'taverna', nome: 'Taverna do Porco Manco', tipo: 'social', x: 1, y: 1, texto: 'Bêbados, jogadores e um bardo que viu gente de túnica vermelha passar.', teste: 'CAR (Rumores) ou uma rodada de bebida', falha: 'O bardo pede 1 ouro para falar.' }, { id: 'mercado', nome: 'Mercado fechado', tipo: 'combate', x: 1, y: 3, texto: 'Bandidos aproveitam a noite para saquear as barracas.', inimigos: [ 'bandido', 'bandido' ] }, { id: 'telhados', nome: 'Pelos telhados', tipo: 'armadilha', x: 2, y: 1, texto: 'O caminho mais rápido é por cima, mas as telhas estão soltas.', teste: 'AGI (Acrobacia)', falha: 'Cai na rua: 2d10 × nível e a guarda vem ver o barulho.' }, { id: 'beco', nome: 'Beco sem saída', tipo: 'enigma', x: 2, y: 3, texto: 'Um muro com três símbolos pintados: um olho, uma chama e uma cobra.', enigma: 'Uma mensagem riscada no chão: "O que vê tudo, queima o que vê."', solucao: 'Tocar o olho e depois a chama. A cobra é armadilha (dispara dardos: 1d10 × nível). O muro gira e abre uma passagem.' }, { id: 'casa', nome: 'Casa do cultista', tipo: 'combate', x: 3, y: 2, texto: 'Três fiéis rezam diante de um cristal vermelho.', inimigos: [ 'cultista', 'acolito_carmesim', 'cultista' ] }, { id: 'capela', nome: 'A capela escondida', tipo: 'maldicao', x: 4, y: 2, texto: 'Um altar com um fragmento de cristal carmesim pulsando.', efeito: 'Quem tocar o cristal sem proteção ganha 2 Marcas Carmesins que só saem com Purificação. Quebrar o cristal exige 3 acertos.' }, { id: 'lider', nome: 'O líder do culto', tipo: 'chefe', x: 4, y: 1, texto: 'Um Aralto de capa escura esperava pelo grupo.', inimigos: [ 'aralto_do_pacto' ] }, { id: 'cartas', nome: 'Mesa das cartas', tipo: 'segredo', x: 5, y: 1, texto: 'Uma mesa cheia de papéis com o selo de um olho vermelho.', segredo: 'As cartas vêm do Reino de Sombrath e falam de "preparar Verdom para o retorno".', tesouro: { dinheiro: 3000, itens: [ { id: 'selo_pacto_rompido', chance: 5 } ] } } ], conexoes: [ [ 'praca', 'taverna' ], [ 'praca', 'mercado' ], [ 'taverna', 'telhados' ], [ 'mercado', 'beco' ], [ 'telhados', 'casa' ], [ 'beco', 'casa', 'Muro que gira' ], [ 'casa', 'capela' ], [ 'capela', 'lider' ], [ 'lider', 'cartas' ] ] },
  { id: 'gornark', nome: 'Gornark, a Cidade sob a Montanha', tipo: 'cidade_subterranea', dificuldade: 3, nivel: 6, lugar: 'Dungeons dos de Gornark', descricao: 'Os de Gornark escavaram uma cidade inteira na montanha do noroeste do Grande Reino dos Orcs. Hoje, só as masmorras ainda funcionam.', segredoFinal: 'Os de Gornark eram orcs que nunca aceitaram ser libertos por humanos. Trancaram-se na montanha para não dever nada a ninguém, e acabaram trancando uns aos outros.', salas: [ { id: 'portao', nome: 'Portão da montanha', tipo: 'entrada', x: 0, y: 1, texto: 'Um portão de ferro enorme, entreaberto.' }, { id: 'rua', nome: 'Rua das casas vazias', tipo: 'exploracao', x: 1, y: 1, texto: 'Casas escavadas na pedra, todas vazias. Pratos ainda na mesa.' }, { id: 'celas', nome: 'Corredor das celas', tipo: 'combate', x: 2, y: 1, texto: 'Prisioneiros enlouquecidos batem nas grades.', inimigos: [ 'bandido', 'orc_sem_cla' ] }, { id: 'prisioneiro', nome: 'A cela 13', tipo: 'social', x: 2, y: 0, texto: 'Um orc velho, lúcido, pede para ser solto.', teste: 'CAR ou Intuição para saber se ele mente', falha: 'Se for solto sem desconfiança, ele rouba um item do grupo e foge.' }, { id: 'correntes', nome: 'Sala das correntes', tipo: 'armadilha', x: 3, y: 1, texto: 'Correntes penduradas no teto que se mexem sozinhas.', teste: 'DEX (Arte da Fuga) para não ser enroscado', falha: 'Preso e 2d10 × nível até alguém soltar.' }, { id: 'registros', nome: 'Sala dos registros', tipo: 'segredo', x: 3, y: 2, texto: 'Livros com os nomes de todos os presos, e por quê.', segredo: 'Os primeiros presos foram os próprios fundadores de Gornark, trancados pelos filhos.' }, { id: 'carcereiro', nome: 'O carcereiro', tipo: 'chefe', x: 4, y: 1, texto: 'O Carcereiro de Gornark guarda a última porta.', inimigos: [ 'carcereiro_gornark' ] }, { id: 'arsenal', nome: 'Arsenal', tipo: 'tesouro', x: 4, y: 0, texto: 'Armas e armaduras dos presos.', tesouro: { dinheiro: 4000, itens: [ { id: 'cota_malha' }, { id: 'machado_fende' }, { id: 'correntes_carcereiro', chance: 20 } ] } }, { id: 'saida', nome: 'Saída dos fundadores', tipo: 'bencao', x: 5, y: 1, texto: 'Um túnel que dá para uma encosta com vista para todo o reino.', oculta: true, efeito: 'Quem parar para ver o nascer do sol daqui recupera todo o recurso da classe.' } ], conexoes: [ [ 'portao', 'rua' ], [ 'rua', 'celas' ], [ 'celas', 'prisioneiro' ], [ 'celas', 'correntes' ], [ 'correntes', 'registros' ], [ 'correntes', 'carcereiro' ], [ 'carcereiro', 'arsenal' ], [ 'carcereiro', 'saida', 'Porta escondida atrás do trono do carcereiro' ] ] },
  { id: 'palacio_vermilion', nome: 'O Palácio Afundado de Vermilion', tipo: 'ruina', dificuldade: 4, nivel: 9, lugar: 'Ruínas de Vermilion', descricao: 'O palácio da cidade antiga ainda está de pé, meio enterrado sob Verdom. No centro dele fica o fosso onde ninguém constrói.', segredoFinal: 'Vermilion não caiu por guerra: o último rei abriu o fosso para esconder algo que achou nos Vasos do Passado. O que saiu de lá devorou a cidade.', salas: [ { id: 'muralha', nome: 'Muralha caída', tipo: 'entrada', x: 0, y: 2, texto: 'Uma brecha na muralha, sob o porão de uma casa de Verdom.' }, { id: 'patio', nome: 'Pátio das sentinelas', tipo: 'combate', x: 1, y: 2, texto: 'Armaduras vazias marcham em círculos.', inimigos: [ 'sentinela_vermilion' ] }, { id: 'banquete', nome: 'Salão do banquete', tipo: 'combate', x: 2, y: 1, texto: 'A mesa ainda está posta. Os convidados não estão vivos.', inimigos: [ 'nobre_espectral' ] }, { id: 'biblioteca', nome: 'Biblioteca real', tipo: 'segredo', x: 2, y: 3, texto: 'Livros apodrecidos e um diário do último rei.', segredo: 'O rei escreve que "encontrou um dos Vasos" e que "o que dorme nele promete poder a quem o acordar".' }, { id: 'capela', nome: 'Capela da chama', tipo: 'bencao', x: 3, y: 3, texto: 'Uma pequena chama ainda arde num altar, sem combustível.', efeito: 'Quem rezar aqui ganha +2 na chance de defesa contra mortos-vivos até sair das ruínas.' }, { id: 'trono', nome: 'Sala do trono', tipo: 'enigma', x: 3, y: 1, texto: 'O trono vazio tem três encaixes: uma coroa, uma espada e uma chave.', enigma: 'Na base do trono: "O rei que governa, o capitão que defende, o carcereiro que guarda."', solucao: 'Coroa Enferrujada, a espada Rubra e as Chaves de Gornark (ou qualquer chave antiga). Sem os três, a porta atrás do trono só abre com FOR e barulho, e o barulho acorda o Devorador mais cedo.' }, { id: 'cofre', nome: 'Cofre real', tipo: 'tesouro', x: 4, y: 1, texto: 'Ouro de uma cidade que não existe mais.', oculta: true, tesouro: { dinheiro: 30000, itens: [ { id: 'coroa_vermilion', chance: 30 }, { id: 'rubra_vermilion', chance: 10 } ] } }, { id: 'escadaria', nome: 'Escadaria para o fosso', tipo: 'armadilha', x: 3, y: 2, texto: 'Degraus que descem para a escuridão. Metade deles não existe mais.', teste: 'AGI ou DEX, e fazer silêncio (DEX Furtividade)', falha: 'Cai e faz barulho: 3d10 × nível, e o Devorador acorda.' }, { id: 'fosso', nome: 'A beira do fosso', tipo: 'chefe', x: 4, y: 2, texto: 'Tentáculos sobem do escuro.', inimigos: [ 'devorador_do_fosso' ] } ], conexoes: [ [ 'muralha', 'patio' ], [ 'patio', 'banquete' ], [ 'patio', 'biblioteca' ], [ 'biblioteca', 'capela' ], [ 'banquete', 'trono' ], [ 'trono', 'cofre', 'Porta atrás do trono' ], [ 'trono', 'escadaria' ], [ 'capela', 'escadaria' ], [ 'escadaria', 'fosso' ] ] },
  { id: 'templo_semideuses', nome: 'O Templo dos Semideuses', tipo: 'templo', dificuldade: 4, nivel: 12, lugar: 'Ruínas do Templo dos Semideuses', descricao: 'O templo onde as raças mortais adoravam os semideuses erguidos pelo Deus Único. Cada capela ainda guarda a vontade de um deles.', segredoFinal: 'Os semideuses foram mortais escolhidos pelo Deus Único para vencer o Deus Marcado. Uma inscrição no altar diz que "o que foi feito de mortais pode ser feito de novo".', salas: [ { id: 'atrio', nome: 'Átrio', tipo: 'entrada', x: 0, y: 2, texto: 'Seis estátuas sem rosto olham para a porta.' }, { id: 'humana', nome: 'Capela humana', tipo: 'bencao', x: 1, y: 1, texto: 'Uma chama que muda de cor a cada minuto.', efeito: 'Quem mudar de ideia sobre algo importante diante da chama ganha +1 em todos os testes até o fim da sessão.' }, { id: 'ana', nome: 'Capela anã', tipo: 'armadilha', x: 1, y: 3, texto: 'Uma bigorna gigante pendurada por correntes gastas.', teste: 'PER para ver a placa de pressão, INT (Engenharia) para travar', falha: 'A bigorna cai: 4d10 × nível em quem estiver embaixo.' }, { id: 'elfica', nome: 'Capela élfica', tipo: 'segredo', x: 2, y: 1, texto: 'Paredes de cristal com uma figura alta de cabelos brancos.', segredo: 'A figura é Vandamor, o elfo que liderou a rebelião contra o Deus Único. Os elfos o adoravam como a um semideus, mesmo sem ser um.' }, { id: 'tobi', nome: 'Capela de Tobi', tipo: 'maldicao', x: 2, y: 3, texto: 'Uma capela minúscula, cheia de piadas escritas nas paredes.', efeito: 'Quem não rir de nenhuma piada (teste de FDV para segurar o riso, se quiser) é amaldiçoado: tropeça no primeiro passo de cada combate (−1 de movimento) até o fim da sessão.' }, { id: 'serpente', nome: 'Capela serpentariana', tipo: 'combate', x: 3, y: 1, texto: 'Guardiões de escamas protegem a capela.', inimigos: [ 'guarda_real_vassk' ] }, { id: 'karlach', nome: 'Capela karlach', tipo: 'bencao', x: 3, y: 3, texto: 'Um braseiro que nunca apaga.', efeito: 'Quem segurar a mão sobre o fogo por um turno (sofre 2d10 × nível) fica imune a fogo até o fim da sessão.' }, { id: 'altar', nome: 'Salão do altar', tipo: 'chefe', x: 4, y: 2, texto: 'No centro, uma estátua enorme se levanta.', inimigos: [ 'eco_semideus' ] }, { id: 'relicario', nome: 'Relicário', tipo: 'tesouro', x: 5, y: 2, texto: 'Nichos com relíquias. A maioria está vazia.', tesouro: { dinheiro: 20000, itens: [ { id: 'coroa_chama_breve', chance: 10 }, { id: 'grevas_pedra', chance: 10 }, { id: 'manto_centelha', chance: 10 }, { id: 'escamas_primeira_muda', chance: 10 }, { id: 'cetro_brasa_viva', chance: 10 }, { id: 'bolsa_sem_fundo', chance: 10 } ] } } ], conexoes: [ [ 'atrio', 'humana' ], [ 'atrio', 'ana' ], [ 'humana', 'elfica' ], [ 'ana', 'tobi' ], [ 'elfica', 'serpente' ], [ 'tobi', 'karlach' ], [ 'serpente', 'altar' ], [ 'karlach', 'altar' ], [ 'altar', 'relicario' ] ] },
  { id: 'fissura', nome: 'A Fissura', tipo: 'fosso', dificuldade: 5, nivel: 18, lugar: 'Grande Lago Central', descricao: 'A cicatriz que a Batalha Colossal deixou no fundo do Grande Lago. Só dá para descer com Guelras, Bênção da Tartaruga ou algo parecido.', segredoFinal: 'No fundo da Fissura há um ovo enorme, metade escama verde, metade cristal vermelho, ainda quente. É isso que a Tartaruga Magnalaga procura.', salas: [ { id: 'borda', nome: 'A borda', tipo: 'entrada', x: 0, y: 1, texto: 'A água escurece de repente. Lá embaixo, brilhos verdes e vermelhos.' }, { id: 'parede', nome: 'Parede de escamas', tipo: 'exploracao', x: 1, y: 1, texto: 'A parede da fenda é coberta de escamas de Jurgmund incrustadas na rocha.', tesouro: { itens: [ { id: 'escama_viva', chance: 25 } ] } }, { id: 'bolha', nome: 'Bolsão de ar', tipo: 'descanso', x: 1, y: 2, texto: 'Uma caverna com ar respirável, presa na rocha.', efeito: 'Dá para descansar aqui uma vez: recupera metade da vida e dos usos de magias por batalha.' }, { id: 'cristais', nome: 'Floresta de cristais', tipo: 'armadilha', x: 2, y: 1, texto: 'Cristais carmesins crescem para todos os lados, pulsando.', teste: 'DEX para passar sem encostar', falha: 'Cada encostada: 2d10 × nível e 1 Marca Carmesim.' }, { id: 'mistura', nome: 'Onde as essências se misturam', tipo: 'maldicao', x: 2, y: 2, texto: 'A água aqui é verde e vermelha ao mesmo tempo.', efeito: 'Todos fazem teste de FDV. Quem falhar sofre a Dupla Natureza até sair da Fissura: a cada turno, fica imune a um tipo de dano e recebe o dobro do outro.' }, { id: 'nascidos', nome: 'Ninho dos Nascidos', tipo: 'combate', x: 3, y: 1, texto: 'Criaturas meio escama, meio cristal, protegem algo mais abaixo.', inimigos: [ 'nascido_da_fissura' ] }, { id: 'vaso', nome: 'O fragmento do Vaso', tipo: 'segredo', x: 3, y: 2, texto: 'Um caco de cerâmica enorme, coberto de runas élficas, preso na rocha.', oculta: true, segredo: 'É um pedaço dos Vasos do Passado, onde o Deus Marcado ficou selado. Os Vasos foram quebrados, mas nem todos os cacos estão perdidos.' }, { id: 'guardiao', nome: 'O guardião do fundo', tipo: 'chefe', x: 4, y: 1, texto: 'Dois Nascidos maiores que os outros, enrolados em volta do ovo.', inimigos: [ 'nascido_da_fissura', 'nascido_da_fissura' ] }, { id: 'ovo', nome: 'O ovo', tipo: 'tesouro', x: 5, y: 1, texto: 'O ovo pulsa. A água em volta é morna.', tesouro: { itens: [ { id: 'perola_fissura', chance: 50 } ] }, efeito: 'Tocar o ovo faz a Tartaruga Magnalaga sentir o grupo, onde quer que ela esteja.' } ], conexoes: [ [ 'borda', 'parede' ], [ 'parede', 'bolha' ], [ 'parede', 'cristais' ], [ 'bolha', 'mistura' ], [ 'cristais', 'nascidos' ], [ 'mistura', 'nascidos' ], [ 'mistura', 'vaso', 'Fresta entre os cristais' ], [ 'nascidos', 'guardiao' ], [ 'guardiao', 'ovo' ] ] }
];
