...
const MAGIAS = [
  ...
  { id: 'familiar',        nome: 'Familiar',           categoria: 'invocacao', tier: 'comum',    resumo: 'Batedor que não luta',
    ...
    efeito: 'Um pequeno espírito animal (coruja, gato ou rato) obedece você por 1 hora. Você enxerga pelos olhos dele. Ele não luta.' },
  { id: 'lobo_espiritual', nome: 'Lobo Espiritual',    categoria: 'invocacao', tier: 'raro',     resumo: 'Aliado 2d10 por 3 turnos',
    calc: null, dado: 2, alcance: '3 hex', usos: { qtd: 1, por: 'batalha' },
    efeito: 'Um lobo luta por 3 turnos: vida 20 × nível, move 6 hex e faz 1 ataque por turno de 2d10 × nível.' },
  { id: 'elemental_fogo',  nome: 'Elemental de Fogo',  categoria: 'invocacao', tier: 'perfeito', resumo: 'Aliado com dano em área',
    ...
    efeito: 'Um elemental luta por 4 turnos: vida 50 × nível, move 4 hex e, no turno dele, causa 3d10 × nível em todos os adjacentes.' },
  ...
  { id: 'servo_invisivel', nome: 'Servo Invisível', categoria: 'invocacao', tier: 'comum', resumo: 'Ajudante que carrega 20 kg',
    ...
    efeito: 'Uma força invisível obedece ordens simples por 1 hora: carrega até 20 kg, abre portas, limpa e busca objetos. Não luta.' },
  { id: 'guardioes_espectrais', nome: 'Guardiões Espectrais', categoria: 'invocacao', tier: 'perfeito', resumo: '2 aliados 2d10 por 4 turnos',
    calc: null, dado: 2, alcance: '4 hex', usos: { qtd: 1, por: 'batalha' },
    efeito: 'Dois cavaleiros fantasmas lutam por 4 turnos: cada um tem vida 30 × nível, move 4 hex e faz 1 ataque por turno de 2d10 × nível.' },
  { id: 'dragao_jovem', nome: 'Invocar Dragão Jovem', categoria: 'invocacao', tier: 'lendario', resumo: 'Dragão com sopro 5d10',
    ...
    efeito: 'Um dragão jovem luta por 5 turnos: vida 100 × nível, voa 8 hex e morde por 4d10 × nível. Uma vez, pode soprar fogo num cone de 5 hex por 5d10 × nível.' },
  { id: 'avatar_kaelthar', nome: 'O Avatar de Kaelthar', categoria: 'invocacao', tier: 'unico', resumo: 'Titã 6d10 por 3 turnos',
    calc: null, dado: 6, alcance: '6 hex', usos: { qtd: 1, por: 'sessao' },
    efeito: 'O titã esquecido Kaelthar se ergue por 3 turnos: vida 200 × nível, move 3 hex e faz 2 ataques por turno de 6d10 × nível contra todos os adjacentes.',
...
const MONSTROS = [
  ...
  { id: 'bandido', nome: 'Bandido', tipo: 'Humanoide', tamanho: 'medio', dificuldade: 2, local: 'Caminho para o Deserto de Karlach',
    ...
    drops: [ { item: 'espada_curta', chance: 20 }, { item: 'broquel', chance: 10 }, { item: 'gibao_couro', chance: 15 }, { texto: '3d10 moedas de prata', chance: 90 } ] },
  ...
  { id: 'orc', nome: 'Orc', tipo: 'Humanoide', tamanho: 'medio', dificuldade: 2, local: 'Acampamentos Orcs',
    ...
    drops: [ { item: 'machado_batalha', chance: 15 }, { item: 'elmo_ferro', chance: 10 }, { texto: 'Presa de orc', chance: 40 }, { texto: '2d10 moedas de prata', chance: 60 } ] },
  ...
  { id: 'cultista', nome: 'Cultista', tipo: 'Humanoide', tamanho: 'medio', dificuldade: 2, local: 'Cidade Baixa (Verdom)',
    ...
    habilidades: [],
    drops: [ { item: 'varinha_freixo', chance: 10 }, { item: 'tunica_encantada', chance: 15 }, { texto: 'Símbolo profano', chance: 50 }, { texto: '2d10 moedas de prata', chance: 50 } ] },
  ...
  { id: 'grakk', nome: 'Grakk, o Rei dos Esgotos', tipo: 'Humanoide', tamanho: 'pequeno', dificuldade: 2, local: 'Esgotos de Verdom', especial: 'Chefe',
    ...
    drops: [ { item: 'cota_malha', chance: 50 }, { item: 'espada_longa', chance: 40 }, { texto: 'Coroa de lata do Rei Goblin', chance: 100 }, { texto: '5d10 moedas de prata', chance: 100 } ] },
  // =====================================================================
  ...
  { id: 'carnical_marcado', nome: 'Carniçal Marcado', tipo: 'Morto-vivo', tamanho: 'medio', dificuldade: 2, local: 'Ruínas da Antiga Cidade', origem: 'deus_marcado',
    ...
    resistencias: 'Imune a veneno e a sangramento.',
    drops: [ { texto: 'Cantil de água do oásis de Sethar (contaminada)', chance: 30 }, { texto: '1d10 moedas de prata antigas', chance: 60 } ] },
  ...
  { id: 'golem_carmesim', nome: 'Golem de Cristal Carmesim', tipo: 'Constructo', tamanho: 'grande', dificuldade: 3, local: 'Lago Corrompido', origem: 'deus_marcado',
    ...
    drops: [ { item: 'punhos_refratores', chance: 5 }, { texto: 'Núcleo de cristal carmesim', chance: 70 }, { texto: 'Lasca de cristal carmesim', chance: 100 } ] },
  ...
  { id: 'aralto_do_pacto', nome: 'Aralto do Pacto', tipo: 'Humanoide', tamanho: 'medio', dificuldade: 3, local: 'Cavernas do Pacto', origem: 'deus_marcado', especial: 'Elite',
    ...
    drops: [ { item: 'selo_pacto_rompido', chance: 5 }, { item: 'espada_juramento', chance: 30 }, { item: 'broquel_duelista', chance: 20 }, { texto: 'Selo de juramento do Aralto', chance: 100 }, { texto: 'Mapa com a localização de um fragmento', chance: 25 } ] },
  ...
  { id: 'cria_de_karlac', nome: 'Cria de Karlach', tipo: 'Réptil', tamanho: 'grande', dificuldade: 4, local: 'Deserto de Karlach', origem: 'deus_marcado',
    ...
    drops: [ { item: 'luvas_de_brasa', chance: 5 }, { texto: 'Pele de brasa da Cria', chance: 60 }, { texto: 'Núcleo de cristal carmesim', chance: 40 }, { item: 'cajado_centelha', chance: 10 } ] },

  { id: 'aralto_sussurrante', nome: 'O Aralto Sussurrante', tipo: 'Humanoide', tamanho: 'medio', dificuldade: 4, local: 'Montanhas de Atrelon', origem: 'deus_marcado', especial: 'Chefe',
    ...
    drops: [ { item: 'mascara_sussurrante', chance: 100 }, { item: 'lamina_duelista', chance: 40 }, { texto: 'Cartas ao rei Vassk', chance: 100 } ] },
  ...
  { id: 'serpentariano', nome: 'Guerreiro Serpentariano', tipo: 'Humanoide', tamanho: 'medio', dificuldade: 2, local: 'Montanhas de Atrelon', origem: 'jurgmund',
    descricao: 'Um humano de pele escamosa, olhos de pupila vertical e língua bifurcada, com lança e escudo.',
    ...
    drops: [ { item: 'espada_longa', chance: 20 }, { item: 'broquel', chance: 15 }, { texto: 'Pele trocada de Serpentariano', chance: 50 }, { texto: '2d10 moedas de prata', chance: 60 } ] },
  ...
  { id: 'carne_errante', nome: 'Carne Errante', tipo: 'Aberração', tamanho: 'grande', dificuldade: 3, local: 'Grande Lago Central', origem: 'jurgmund',
    ...
    drops: [ { item: 'escama_viva', chance: 5 }, { texto: 'Escama de Jurgmund', chance: 80 }, { texto: 'Um item aleatório de alguém que ela engoliu', chance: 50 } ] },
  ...
  { id: 'nascido_da_fissura', nome: 'Nascido da Fissura', tipo: 'Aberração', tamanho: 'grande', dificuldade: 4, local: 'Grande Lago Central', origem: 'fissura',
    ...
    drops: [ { item: 'perola_fissura', chance: 5 }, { texto: 'Escama de Jurgmund', chance: 70 }, { texto: 'Núcleo de cristal carmesim', chance: 70 }, { texto: 'Pérola da Fissura (material raro)', chance: 20 } ] },
  ...
  { id: 'harpia', nome: 'Harpia', tipo: 'Monstruosidade', tamanho: 'medio', dificuldade: 2, local: 'Antigo Navio de Guerra',
    ...
    drops: [ { texto: 'Pena de harpia', chance: 60 }, { texto: 'Bugiganga roubada', chance: 40 } ] },
  ...
  { id: 'mimico', nome: 'Mímico', tipo: 'Aberração', tamanho: 'medio', dificuldade: 2, local: 'Antigo Navio de Guerra',
    ...
    drops: [ { texto: 'Tesouro de verdade que ele guardava (3d10 moedas de ouro)', chance: 70 }, { item: 'anel_guarda', chance: 15 } ] },
  ...
  { id: 'cubo_gelatinoso', nome: 'Cubo Gelatinoso', tipo: 'Aberração', tamanho: 'grande', dificuldade: 3, local: 'Ruínas de Vermilion',
    ...
    drops: [ { texto: 'Moedas e ossos de vítimas antigas (2d10 moedas de ouro)', chance: 80 }, { item: 'espada_longa', chance: 20 }, { item: 'anel_prata', chance: 15 } ] },
  ...
  { id: 'troll', nome: 'Troll', tipo: 'Gigante', tamanho: 'grande', dificuldade: 3, local: 'Grutas do Troll',
    ...
    drops: [ { item: 'coracao_troll', chance: 5 }, { texto: 'Sangue de troll (poção de cura instável)', chance: 40 }, { texto: 'Dente de troll', chance: 70 } ] },
  ...
  { id: 'banshee', nome: 'Banshee', tipo: 'Morto-vivo', tamanho: 'medio', dificuldade: 3, local: 'Lago do Pobre',
    ...
    resistencias: 'Imune a veneno, sangramento e agarrão.',
    drops: [ { item: 'veu_do_lamento', chance: 5 } ] },

  { id: 'wyvern', nome: 'Wyvern', tipo: 'Dragão menor', tamanho: 'grande', dificuldade: 3, local: 'Montanhas de Atrelon',
    ...
    drops: [ { item: 'lanca_ferrao_wyvern', chance: 5 }, { texto: 'Ferrão de wyvern', chance: 60 }, { texto: 'Couro de wyvern', chance: 50 } ] },
  ...
  { id: 'manticora', nome: 'Mantícora', tipo: 'Monstruosidade', tamanho: 'grande', dificuldade: 4, local: 'Ruínas Grúticas',
    ...
    drops: [ { item: 'arco_espinhos_manticora', chance: 5 }, { texto: 'Espinhos de mantícora (12 flechas raras)', chance: 60 }, { texto: 'Juba de mantícora', chance: 40 } ] },
  ...
  { id: 'golem_de_ferro', nome: 'Golem de Ferro Anão', tipo: 'Constructo', tamanho: 'grande', dificuldade: 4, local: 'Forte Anão da Guarda',
    ...
    drops: [ { item: 'nucleo_runico', chance: 5 }, { texto: 'Núcleo rúnico anão', chance: 60 }, { texto: 'Placas de ferro rúnico', chance: 80 }, { item: 'manoplas_carrasco', chance: 15 } ] },
  ...
  { id: 'lich', nome: 'Lich', tipo: 'Morto-vivo', tamanho: 'medio', dificuldade: 5, local: 'Ruínas de Vermilion', especial: 'Chefe',
    ...
    drops: [ { item: 'filacterio_vazio', chance: 10 }, { item: 'cajado_centelha', chance: 60 }, { item: 'grimorio_viajante', chance: 40 }, { texto: 'Grimório do Lich (magia lendária à escolha do mestre)', chance: 100 }, { texto: '10d10 moedas de ouro', chance: 100 } ] },
  ...
  { id: 'sentinela_vermilion', nome: 'Sentinela de Vermilion', tipo: 'Constructo', tamanho: 'medio', dificuldade: 3, local: 'Ruínas de Vermilion',
    ...
    resistencias: 'Imune a veneno, sangramento e condições de mente.',
    drops: [ { item: 'couraca_ferro', chance: 20 }, { texto: 'Placa de armadura com o brasão de Vermilion', chance: 60 }, { item: 'coroa_vermilion', chance: 3 } ] },
  ...
  { id: 'nobre_espectral', nome: 'Nobre Espectral de Vermilion', tipo: 'Morto-vivo', tamanho: 'medio', dificuldade: 3, local: 'Ruínas de Vermilion',
    ...
    drops: [ { texto: 'Joia antiga de Vermilion (vale 3d10 moedas de ouro)', chance: 50 }, { item: 'coroa_vermilion', chance: 5 } ] },
  ...
  { id: 'devorador_do_fosso', nome: 'O Devorador do Fosso', tipo: 'Aberração', tamanho: 'grande', dificuldade: 4, especial: 'Perigo local', origem: 'desconhecida', local: 'Ruínas de Vermilion',
    ...
    drops: [ { item: 'rubra_vermilion', chance: 10 }, { texto: 'Ossos e tesouros das vítimas (5d10 moedas de ouro)', chance: 100 } ] },
  ...
  { id: 'faroleiro_afogado', nome: 'O Faroleiro Afogado', tipo: 'Morto-vivo', tamanho: 'medio', dificuldade: 3, especial: 'Perigo local', local: 'Farol da Perdição',
    ...
    drops: [ { item: 'lanterna_perdicao', chance: 10 }, { texto: 'Diário de bordo encharcado', chance: 60 } ] },
  ...
  { id: 'gargula_grutica', nome: 'Gárgula Grútica', tipo: 'Constructo', tamanho: 'medio', dificuldade: 3, local: 'Ruínas Grúticas',
    ...
    resistencias: 'Imune a veneno, sangramento e condições de mente.',
    drops: [ { texto: 'Olho de pedra-lume', chance: 30 } ] },
  ...
  { id: 'soberano_enterrado', nome: 'O Soberano Enterrado', tipo: 'Morto-vivo', tamanho: 'medio', dificuldade: 4, especial: 'Chefe', local: 'Ruínas da Antiga Cidade',
    ...
    resistencias: 'Imune a veneno, sangramento e condições de mente.',
    drops: [ { item: 'coroa_soberano', chance: 30 }, { texto: 'Tesouro real da cidade antiga (8d10 moedas de ouro)', chance: 100 } ] },
  ...
  { id: 'eco_semideus', nome: 'Eco de Semideus', tipo: 'Constructo', tamanho: 'grande', dificuldade: 4, especial: 'Guardião', local: 'Ruínas do Templo dos Semideuses',
    ...
    resistencias: 'Imune a veneno, sangramento e condições de mente.',
    drops: [ { item: 'coroa_chama_breve', chance: 5 }, { item: 'manto_centelha', chance: 5 }, { item: 'escamas_primeira_muda', chance: 5 },
  ...
  { id: 'quimera', nome: 'A Quimera', tipo: 'Monstruosidade', tamanho: 'grande', dificuldade: 4, especial: 'Perigo local', local: 'Covil da Quimera',
    ...
    drops: [ { item: 'chifre_quimera', chance: 15 }, { texto: 'Juba da Quimera', chance: 60 } ] },
  ...
  { id: 'murlach', nome: 'Murlach', tipo: 'Dragão marinho', tamanho: 'colossal', dificuldade: 5, especial: 'Colosso', origem: 'desconhecida', local: 'Mar de Murlach',
    ...
    drops: [ { item: 'escama_abissal_murlach', chance: 25 }, { texto: 'Dente de Murlach (material lendário)', chance: 100 } ] },
  ...
  { id: 'arquidemonio', nome: 'O Arquidemônio', tipo: 'Demônio', tamanho: 'grande', dificuldade: 5, especial: 'Chefe', origem: 'desconhecida', local: 'Acampamento do Arquidemônio',
    ...
    drops: [ { item: 'contrato_arquidemonio', chance: 25 }, { texto: 'Chifre do Arquidemônio', chance: 100 }, { texto: 'Mercadorias infernais da tenda (10d10 moedas de ouro)', chance: 100 } ] },
  ...
  { id: 'xama_orc', nome: 'Xamã Orc', tipo: 'Humanoide', tamanho: 'medio', dificuldade: 2, local: 'Acampamentos Orcs',
    ...
    drops: [ { texto: 'Colar de ossos do xamã', chance: 60 }, { item: 'simbolo_prata', chance: 15 } ] },
  ...
  { id: 'orc_sem_cla', nome: 'Orc Sem-Clã', tipo: 'Humanoide', tamanho: 'medio', dificuldade: 3, local: 'Caminho de Planatux',
    ...
    drops: [ { item: 'machado_batalha', chance: 20 }, { item: 'cota_malha', chance: 15 }, { texto: 'Pedágio roubado (4d10 moedas de prata)', chance: 80 } ] },
  ...
  { id: 'carcereiro_gornark', nome: 'O Carcereiro de Gornark', tipo: 'Humanoide', tamanho: 'grande', dificuldade: 3, especial: 'Perigo local', local: 'Dungeons dos de Gornark',
    ...
    drops: [ { item: 'correntes_carcereiro', chance: 10 }, { texto: 'Chaves das masmorras de Gornark', chance: 100 } ] },
  ...
  { id: 'campeao_lonkcarn', nome: 'O Campeão de Lonk-Carn', tipo: 'Humanoide', tamanho: 'medio', dificuldade: 4, especial: 'Chefe', local: 'Grande Cidade Orc Lonk-Carn',
    ...
    drops: [ { item: 'cinturao_campeao', chance: 100 }, { item: 'machado_grande_reino', chance: 20 } ] },
  ...
  { id: 'espirito_ancestral_orc', nome: 'Espírito Ancestral Orc', tipo: 'Morto-vivo', tamanho: 'grande', dificuldade: 4, especial: 'Guardião', local: 'Área do Desafio de Poder',
    ...
    resistencias: 'Imune a veneno, sangramento e agarrão.',
    drops: [ { item: 'marca_desafio_poder', chance: 100 }, { item: 'machado_grande_reino', chance: 10 } ] },
  ...
  { id: 'bruxa_do_moinho', nome: 'A Bruxa do Moinho', tipo: 'Humanoide', tamanho: 'medio', dificuldade: 4, especial: 'Chefe', local: 'Antigo Moinho da Bruxa',
    ...
    drops: [ { item: 'roca_bruxa', chance: 20 }, { texto: 'Caldeirão com ingredientes raros', chance: 70 } ] },
  ...
  { id: 'acolito_carmesim', nome: 'Acólito Carmesim', tipo: 'Humanoide', tamanho: 'medio', dificuldade: 2, origem: 'deus_marcado', local: 'Floresta Morta do Clérigo',
    ...
    drops: [ { texto: 'Túnica vermelha com o olho marcado', chance: 50 }, { texto: 'Lasca de cristal carmesim', chance: 30 } ] },
  ...
  { id: 'cavaleiro_carmesim', nome: 'Cavaleiro Carmesim', tipo: 'Humanoide', tamanho: 'medio', dificuldade: 3, origem: 'deus_marcado', local: 'Floresta Morta do Clérigo',
    ...
    drops: [ { item: 'couraca_ferro', chance: 20 }, { item: 'escudo_torre', chance: 15 }, { texto: 'Lasca de cristal carmesim', chance: 60 } ] },
  ...
  { id: 'grande_clerigo', nome: 'O Grande Clérigo do Deus Marcado', tipo: 'Humanoide', tamanho: 'medio', dificuldade: 5, especial: 'Chefe', origem: 'deus_marcado', local: 'Castelo do Grande Clérigo do Deus-Marcado',
    ...
    drops: [ { item: 'relicario_deus_marcado', chance: 60 }, { texto: 'Escrituras da Igreja do Deus Marcado', chance: 100 }, { texto: 'Lista de fragmentos já recolhidos pelos Araltos', chance: 50 } ] },
  ...
  { id: 'goblin_cinza', nome: 'Goblin Cinza', tipo: 'Humanoide', tamanho: 'pequeno', dificuldade: 2, local: 'Goblins Cinzas',
    ...
    drops: [ { item: 'polvora_cinza', chance: 10 }, { texto: 'Óculos de solda goblin', chance: 40 } ] },
  ...
  { id: 'verme_do_casco', nome: 'O Verme do Casco', tipo: 'Aberração', tamanho: 'colossal', dificuldade: 4, especial: 'Perigo local', origem: 'deus_marcado', local: 'Subterrâneo do Casco',
    ...
    drops: [ { item: 'nucleo_contaminado', chance: 30 }, { texto: 'Lasca de casco da Tartaruga (material lendário)', chance: 100 } ] },
  ...
  { id: 'guardia_da_entrada', nome: 'A Guardiã da Entrada', tipo: 'Serpente marinha', tamanho: 'grande', dificuldade: 4, especial: 'Guardião', local: 'Entrada da Turtumaga',
    ...
    drops: [ { item: 'lanca_da_entrada', chance: 20 }, { texto: 'Escamas azuis da Guardiã', chance: 70 } ] },
  ...
  { id: 'draco_das_mares', nome: 'Draco das Marés', tipo: 'Dragão menor', tamanho: 'grande', dificuldade: 3, local: 'Ilha Direita',
    ...
    drops: [ { texto: 'Escamas vermelhas de draco', chance: 70 }, { texto: 'Tesouro do ninho (4d10 moedas de ouro)', chance: 60 } ] },
  ...
  { id: 'wyverns_gemeas', nome: 'As Wyverns Gêmeas', tipo: 'Dragão menor', tamanho: 'grande', dificuldade: 4, especial: 'Perigo local', local: 'Ilhas Gemia',
    ...
    drops: [ { item: 'botas_asas_gemeas', chance: 10 }, { texto: 'Ferrão de wyvern', chance: 60 } ] },
  ...
  { id: 'drake_fogo', nome: 'Drake de Fogo', tipo: 'Dragão menor', tamanho: 'medio', dificuldade: 3, local: 'Ilha Esquerda',
    ...
    resistencias: 'Imune a fogo.',
    drops: [ { texto: 'Glândula de fogo de drake', chance: 40 } ] },
...
const REGIOES = [
  ...
  { id: 'outras', nome: 'Outras terras', imagem: null,
    ...
    lugares: [
      { nome: 'Montanhas de Atrelon', temas: ['Atrelon'], desc: 'Onde fica a cabeça de Jurgmund, o Castelo da Cobra e o povo serpentariano do rei Vassk.' },
